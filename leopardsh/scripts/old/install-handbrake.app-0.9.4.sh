...
srcmirror=https://github.com/$appname/$appname/releases/download/$version
dmg=$appname-$version-MacOSX.5_GUI_ppc.dmg
...
test "$(md5 ~/Downloads/$dmg | awk '{print $NF}')" = 9d4368e6fa501578c34743543807b6e1
