...
# Install Camino.app on OS X / PowerPC.

package=camino.app
version=2.1.2
appname1=Camino
upstream_g3=https://www.macintoshrepository.org/download.php?id=26530&go=1
upstream_g4=https://www.macintoshrepository.org/download_donator.php?id=26531&go=1
upstream_g4e=https://www.macintoshrepository.org/download_donator.php?id=26532&go=1
upstream_g5=https://www.macintoshrepository.org/download_donator.php?id=26533&go=1
upstream_website=https://www.macintoshrepository.org/26202-camino-2-1-2
...
tarball=$pkgspec.$($pkgmgr --cpu).tar.gz
