...
# Install OpenMark.app on OS X / PowerPC.

package=openmark.app
version=1.60
appname1=OpenMark
upstream=https://files1.majorgeeks.com/10afebdbffcd4742c81a3cb0f6ce4092156b4375/mac/benchmarking/GioFX%20OpenMark.zip
# if that url doesn't work, visit https://mac.majorgeeks.com/files/details/openmark.html in a browser.
