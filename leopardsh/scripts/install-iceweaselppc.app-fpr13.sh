...
# Install IceWeasel-PPC.app on OS X / PowerPC.

package=iceweaselppc.app
version=fpr13
ucversion=FPR13
appname1=IceWeaselPPC
upstream_website=https://forums.macrumors.com/threads/so-this-finally-happened-sort-of.2172031/page-3#post-27366588
...
for appname in "$appname1" ; do
    ...
    for i in 1 2 3 4 5 ; do
        ...
        echo "  \"/Applications/$appname $ucversion\" -> /opt/$pkgspec/$appname"
        break
    done
done
