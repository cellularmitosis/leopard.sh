...
# Install Petite Chez Scheme (threaded) on OS X / PowerPC.

package=petite-chezscheme
version=8.4t
upstream=https://www.scheme.com/csv8.4/pcsv8.4-tppcosx.tar.gz
...
tarball=$pkgspec.leopard.g4.tar.gz
...
mkdir -p /usr/local/lib/csv8.4
ln -sf /opt/$pkgspec/lib/csv8.4/* /usr/local/lib/csv8.4/
