...
# Install DjView.app on OS X / PowerPC.

package=djview.app
version=4.5
appname1=DjView
upstream=https://sourceforge.net/projects/djvu/files/DjVuLibre_MacOS/3.5.22%2B4.5/djvulibre-3.5.22%2Bdjview-4.5-ppc-3.zip/download
