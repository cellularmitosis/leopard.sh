...
CPPFLAGS="-I/opt/gettext-0.21/include"
LDFLAGS="-L/opt/gettext-0.21/lib"
...
if ! which -s meson ; then
    # leopard.sh meson-1.2.1
    leopard.sh meson-0.64.1
fi

if ! which -s ninja ; then
    leopard.sh ninja-1.11.1
fi
